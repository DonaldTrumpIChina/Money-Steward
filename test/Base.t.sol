...
import {DeployGuard} from "../script/DeployGuard.s.sol";
...
abstract contract Base_Test is Test, IVaultData {
    ...
    DeployGuard public deployer;

    /*//////////////////////////////////////////////////////////////////////////
                                  SET-UP FUNCTION
    //////////////////////////////////////////////////////////////////////////*/
    function setUp() public virtual {
        deployer = new DeployGuard();
        (guard, vaultGuardianGovernor, vaultGuardianToken, networkConfig) = deployer.run();
    ...
    function _labelContracts() internal {
        ...
        vm.label({account: address(guard), newLabel: "Vault Guardians"});
